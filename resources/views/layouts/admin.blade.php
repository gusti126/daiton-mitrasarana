        ...
        <div class="flex h-screen antialiased text-gray-900 bg-gray-100 dark:bg-dark dark:text-light">
          ...
          ">
            ...
            <section x-transition:enter="transition duration-300 ease-in-out transform sm:duration-500"
                ...
                tabindex="-1" x-show="isSettingsPanelOpen" @keydown.escape="isSettingsPanelOpen = false" class="
            fixed
            inset-y-0
            right-0
            z-20
          ...
          " aria-labelledby="settinsPanelLabel">
              ...
              ">
                    ...
                    <div class="flex-1 overflow-hidden hover:overflow-y-auto">
                        ...
                        <div class="p-4 space-y-4 md:p-8">
                            ...
                            <div class="flex items-center space-x-8">
                                <!-- Light button -->
                                <button @click="setLightTheme" class="
                      flex
                      items-center
                      justify-center
                      px-4
                      ...
                      dark:border-primary dark:hover:text-primary-100 dark:hover:border-primary-light
                      focus:outline-none focus:ring focus:ring-primary-lighter focus:ring-offset-2
                    ...
                    " :class="{ 'border-gray-900 text-gray-900 dark:border-primary-light dark:text-primary-100': !isDark, 'text-gray-500 dark:text-primary-light': isDark }">
                                ...
                                <!-- Dark button -->
                                <button @click="setDarkTheme" class="
                      flex
                      items-center
                      justify-center
                      px-4
            ...
            <section x-transition:enter="transition duration-300 ease-in-out transform sm:duration-500"
                ...
                aria-labelledby="notificationPanelLabel" class="
            fixed
            inset-y-0
            z-20
            w-full
          ...
          ">
            ...
            <section x-transition:enter="transition duration-300 ease-in-out transform sm:duration-500"
                ...
                x-transition:leave="transition duration-300 ease-in-out transform sm:duration-500"
                x-transition:leave-start="translate-x-0" x-transition:leave-end="-translate-x-full"
                x-show="isSearchPanelOpen" @keydown.escape="isSearchPanelOpen = false" class="
            fixed
            inset-y-0
            z-20
            w-full
          ...
          ">
                ...
                text-gray-400
                border-b
                dark:border-primary-darker dark:focus-within:text-light
              ...
              ">
                        ...
                        <input x-ref="searchInput" type="text" class="
                  w-full
                  py-2
                  pl-10
                  pr-4
                  border
                  rounded-full
                  dark:bg-dark dark:border-transparent dark:text-light
